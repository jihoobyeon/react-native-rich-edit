...
/*
 * This file is auto-generated from SafeAreaViewNativeComponent spec file in flow / TypeScript.
 */
// clang-format off
#pragma once
...
REACT_STRUCT(SafeAreaViewProps)
struct SafeAreaViewProps : winrt::implements<SafeAreaViewProps, winrt::Microsoft::ReactNative::IComponentProps> {
  SafeAreaViewProps(winrt::Microsoft::ReactNative::ViewProps props, const winrt::Microsoft::ReactNative::IComponentProps& cloneFrom)
    : ViewProps(props)
  {
     if (cloneFrom) {
...
struct SafeAreaViewEventEmitter {
  SafeAreaViewEventEmitter(const winrt::Microsoft::ReactNative::EventEmitter &eventEmitter)
...
struct BaseSafeAreaView {

  virtual void UpdateProps(
    const winrt::Microsoft::ReactNative::ComponentView &/*view*/,
    const winrt::com_ptr<SafeAreaViewProps> &newProps,
    const winrt::com_ptr<SafeAreaViewProps> &/*oldProps*/) noexcept {
    m_props = newProps;
  }
  ...
  virtual void UpdateEventEmitter(const std::shared_ptr<SafeAreaViewEventEmitter> &eventEmitter) noexcept {
    m_eventEmitter = eventEmitter;
  }
  ...
  const winrt::com_ptr<SafeAreaViewProps>& Props() const { return m_props; }

private:
  winrt::com_ptr<SafeAreaViewProps> m_props;
  std::shared_ptr<SafeAreaViewEventEmitter> m_eventEmitter;
};
...
void RegisterSafeAreaViewNativeComponent(
  ...
  packageBuilder.as<winrt::Microsoft::ReactNative::IReactPackageBuilderFabric>().AddViewComponent(
      L"SafeAreaView", [builderCallback](winrt::Microsoft::ReactNative::IReactViewComponentBuilder const &builder) noexcept {
        auto compBuilder = builder.as<winrt::Microsoft::ReactNative::Composition::IReactCompositionViewComponentBuilder>();

        builder.SetCreateProps([](winrt::Microsoft::ReactNative::ViewProps props,
                              const winrt::Microsoft::ReactNative::IComponentProps& cloneFrom) noexcept {
            return winrt::make<SafeAreaViewProps>(props, cloneFrom); 
        });
        ...
        builder.SetUpdatePropsHandler([](const winrt::Microsoft::ReactNative::ComponentView &view,
            ...
            userData->UpdateProps(view, newProps ? newProps.as<SafeAreaViewProps>() : nullptr, oldProps ? oldProps.as<SafeAreaViewProps>() : nullptr);
        });
